...
function DashboardRedirect() {
  ...
  const getDashboardRoute = () => {
    ...
    console.log('Getting dashboard route for user role:', user.role.name, user);
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard" element={
        <RoleBasedRoute requiredRoles={['Admin', 'Super Admin', 'SDRD ADMIN', 'DQAD ADMIN', 'CPD ADMIN', 'FOD ADMIN']}>
          <Dashboard />
        </RoleBasedRoute>
      } />
      ...
      <Route path="/supervisor-dashboard" element={
        <RoleBasedRoute requiredRoles={['Supervisor', 'DS User', 'CPG User', 'SRO User', 'Supervisor (SSO)', 'HQ User', 'Supervisor (FO)', 'AD_DD User']}>
          <SupervisorDashboard />
        </RoleBasedRoute>
      } />
      ...
      <Route path="/enumerator-dashboard" element={
        <RoleBasedRoute requiredRoles={['Enumerator', 'Enumerator (JSO)', 'Enumerator (FI)']}>
          <EnumeratorDashboard />
        </RoleBasedRoute>
      } />
      <Route path="/available-tests" element={
        <RoleBasedRoute requiredRoles={['Enumerator', 'FresherBScBCA', 'Enumerator (JSO)', 'Enumerator (FI)']}>
          <AvailableTests />
        </RoleBasedRoute>
      } />
      ...
      <Route path="/results" element={
        <RoleBasedRoute requiredRoles={['Admin', 'Super Admin', 'SDRD ADMIN', 'DQAD ADMIN', 'CPD ADMIN', 'FOD ADMIN', 'ZO User', 'RO User', 'Supervisor', 'DS User', 'CPG User', 'SRO User', 'Supervisor (SSO)', 'HQ User', 'Supervisor (FO)', 'AD_DD User']}>
          <Results />
        </RoleBasedRoute>
      } />
      ...
      <Route path="/certificates" element={
        <RoleBasedRoute requiredRoles={['Admin', 'Super Admin', 'SDRD ADMIN', 'DQAD ADMIN', 'CPD ADMIN', 'FOD ADMIN', 'ZO User', 'RO User', 'Supervisor', 'DS User', 'CPG User', 'SRO User', 'Supervisor (SSO)', 'HQ User', 'Supervisor (FO)', 'AD_DD User', 'Enumerator', 'FresherBScBCA', 'Enumerator (JSO)', 'Enumerator (FI)']}>
          <Certificates />
        </RoleBasedRoute>
      } />
